...
impl DeviceId {
    ...
    pub fn from_mac_string(s: &str) -> Result<Self, super::error::ParseError> {
...
impl Version {
    ...
    pub fn parse(s: &str) -> Result<Self, super::error::ParseError> {
        use super::error::ParseError;
...
impl Device {
    ...
    pub fn auth_method(&self) -> super::features::AuthMethod {
