...
use crate::airplay::core::{StreamConfig, AudioFormat};
use super::{AirPlayClient, EventHandler};
...
impl ClientBuilder {
    ...
    pub fn airplay2(mut self) -> Self {
        self.stream_config = StreamConfig::realtime_ntp();
        self
    }
...
mod tests {
    use super::*;
    use crate::airplay::core::{StreamType, stream::TimingProtocol};
