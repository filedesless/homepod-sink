...
use crate::airplay::core::{Device, StreamConfig, error::Result};
use crate::airplay::core::error::{Error as CoreError, RtspError};
use crate::airplay::core::features::AuthMethod;
use crate::airplay::rtsp::{RtspConnection, RtspSession, SessionState, RtspRequest};
use crate::airplay::pairing::{PairingSession, PairVerify, PairSetup, ControllerIdentity};
use crate::airplay::crypto::ed25519::IdentityKeyPair;
use std::path::PathBuf;
use std::fs;
// Timing imports reserved for future use
// use crate::airplay::timing::{TimingProtocol, NtpTimingClient, PtpClient};
use crate::airplay::audio::{AudioStreamer, AudioDecoder, LiveAudioDecoder, RtpSender, RtpReceiver, EqConfig, EqParams, SpatialParams, SpeakerConfig};
use crate::airplay::audio::cipher::{PacketCipher, ChaChaPacketCipher};
...
impl Connection {
    ...
    pub async fn start_streaming(&mut self, decoder: AudioDecoder) -> Result<()> {
        ...
        let control_task = if let Some(ref control_rx) = self.control_receiver {
            use crate::airplay::audio::RetransmitRequest;
    ...
    mod connection_state {
        ...
        fn make_test_config() -> StreamConfig {
            StreamConfig {
                ...
                ptp_mode: crate::airplay::core::PtpMode::Master,
                latency_min: 22050,
                latency_max: 132300,
