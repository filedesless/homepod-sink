...
use crate::airplay::core::error::{Result, RtspError};
use crate::airplay::core::stream::TimingProtocol;
use crate::airplay::core::{Device, StreamConfig};
use rand::Rng;
use uuid::Uuid;

use super::plist_codec::{
...
impl RtspSession {
    ...
    pub fn build_setup_phase2(&self) -> Result<Vec<u8>> {
        use crate::airplay::core::codec::AudioCodec;
...
mod tests {
    ...
    use crate::airplay::core::features::Features;
    use crate::airplay::core::stream::StreamType;
    use std::net::IpAddr;
    ...
    fn make_test_device() -> Device {
        Device {
            ...
            public_key: None,
            source_version: crate::airplay::core::device::Version::default(),
    ...
    mod state_transitions {
        ...
        fn setup_phase1_to_ready() {
            ...
            let response2 = SetupPhase2Response {
                streams: vec![super::plist_codec::StreamResponse {
                    stream_type: 96,
                    data_port: 58170,
                    control_port: 58171,
                    stream_id: 1,
