...
//!
//! This module provides a high-level API for managing the complete pairing
//! flow: HomeKit pair-setup and pair-verify.

use super::{PairSetup, PairVerify};
use crate::airplay::core::error::{Error, PairingError, Result};
use crate::airplay::core::features::AuthMethod;
use crate::airplay::crypto::ed25519::IdentityKeyPair;
use crate::airplay::crypto::keys::{SessionKeys, SharedSecret};
...
mod tests {
    use super::*;
    use super::super::pair_setup::MockSetupServer;
    use super::super::pair_verify::MockVerifyServer;
    ...
    mod transient_flow {
        ...
        fn m1_contains_transient_flag() {
            ...
            use crate::airplay::crypto::tlv::{Tlv8, TlvType};
